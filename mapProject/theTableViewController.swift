...
class theTableViewController: UITableViewController {
    var listOfRuns: [String] = []
    let dataManager = DataManager()

    override func viewDidLoad() {
        super.viewDidLoad()
        listOfRuns = dataManager.loadRunList()
...
//        print(listOfRuns)
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return listOfRuns.count
    }


    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell1", for: indexPath) as! theTableViewCell
        cell.theNameLabel.text = listOfRuns[indexPath.row]
        // Configure the cell...
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "showMap":
            ...
            guard let selectedLinkCell = sender as? theTableViewCell else {
            ...
            mapDetailViewController.nameOfrun = listOfRuns[indexPath.row]
